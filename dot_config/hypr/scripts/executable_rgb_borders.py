...
def set_color(r,g,b):
    ...
    subprocess.run(f"hyprctl keyword col.active_border 0xff{rgb_to_hex(r,g,b)}".split())
    subprocess.run(f"hyprctl keyword col.inactive_border 0x66{rgb_to_hex(r,g,b)}".split())
